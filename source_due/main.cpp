...
int main()
{
    ...
    for(;;) {
        ...
        if (loopCount%64 == 0) {
            ...
            strip.write((led_index+n_leds-1+(n_leds/3)%n_leds, 0, 0, 0);
            strip.write((led_index+n_leds-1+(2*n_leds/3)%n_leds, 0, 0, 0);
            ...
            strip.write((led_index+(n_leds/3))%n_leds, 255, 64, 0);
            strip.write((led_index+(2*n_leds/3)%n_leds, 255, 64, 0);
